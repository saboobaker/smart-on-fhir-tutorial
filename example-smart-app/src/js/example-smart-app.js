...
function onError() {
  ...
  function getDocument(data) {
	  return{
		  ...
		  type: { 
		    coding: [{system:"http://loinc.org", code: "34840-9"}]			  
		  },
         indexed: new Date(),
          status: 'current',			 
         docStatus: {
         ...
         content: [ 
		           {
					 ...
					 {						 
		              ...
		              data:''
		             }					   
